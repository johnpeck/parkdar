...
void lcd_init (void) {
    ...
    /* Select asynchronous clock source, enable all COM pins and enable
     * all segment pins. */
    LCDCRB = (1<<LCDCS) | (3<<LCDMUX0) | (7<<LCDPM0);

    /* Set LCD prescaler to give a framerate of 32 Hz */
    ...
    gLCD_Update_Required = FALSE; // Used in LCD interrupt routine
}
